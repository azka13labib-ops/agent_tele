...
function ensureDirs() {
  [KNOWLEDGE_DIR, NOTES_DIR, REPOS_DIR].forEach(dir => {
...
function getOpenAIClient() {
  const apiKey = process.env.NINEROUTER_API_KEY || process.env.ROUTER9_API_KEY || process.env.AI_API_KEY || process.env.TOKENHARBOR_API_KEY || process.env.OPEN_ROUTER_API_KEY;
